...
<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<h2 class="pull-left m-r-sm">Mail Template CSS</h2>
					<div class="heading-tools"><button class="btn btn-sm m-r-sm"><i class="fa fa-chevron-left fa-fw"></i>Back</button></div>
				</div>
			</div>
							...
							<div class="ibox-content">
								<div class="form-group">
									<div class="border-box">
										<textarea id="editor_css" height="600px"></textarea>
									</div>
								</div>
							</div>
...
export default {
    ...
    mounted: function(){
        var jsEditor = CodeMirror.fromTextArea(document.getElementById('editor_css'), {
			mode: "javascript",
			lineNumbers: true,
			indentUnit: 2
		});
