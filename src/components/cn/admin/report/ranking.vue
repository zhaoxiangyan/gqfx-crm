    ...
    <div id="wrapper">
				...
				<ul class="nav metismenu skin-3" id="side-menu">
					...
					<li class="active">
						...
						<ul class="nav nav-second-level collapse">
							...
							<li class="active"><a href="../report/ranking.html">Trade Ranking</a></li>
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<h2 class="pull-left m-r-sm">Ranking / <small>Top Winner and Top Loser</small></h2>
				</div>
			</div>
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								...
								<div class="col-lg-6">
								  <div class="m-b-sm text-primary text-md">Top Winner</div>
									<div class="table-responsive">
										<table class="table report-rk-table">
											<thead>
												<tr class="gray-bg">
													<th width="5%">No</th>
													<th>Client ID</th>
								...
								<div class="col-lg-6">
									<div class="m-b-sm text-danger text-md">Top Loser</div>
									<div class="table-responsive">
										<table class="table report-rk-table">
											<thead>
												<tr class="gray-bg">
							...
							<div class="ibox-content">
								<div class="ranking-wrapper">
									...
									<div class="col-lg-6">
										<div class="m-b-sm text-danger text-md">Top Loser</div>
										<div class="table-responsive">
											<table class="table table-hover report-rk-table">
												<thead>
													<tr class="gray-bg">
														<th width="5%">No</th>
														<th>Client ID</th>
