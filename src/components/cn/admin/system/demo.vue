<template>
	<div id="wrapper">
					...
					<ul class="nav metismenu skin-3" id="side-menu">
						...
						<li class="active">
							...
							<ul class="nav nav-second-level collapse">
								...
								<li class="active"><a href="../system/demo.html">Demo Account</a></li>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<h2 class="pull-left m-r-sm">Demo Account</h2>
				</div>
			</div>		
							...
							<div class="ibox-content">
								<div class="form-horizontal">
									<div class="form-group">
										<label class="col-sm-2">Demo Account Active</label>
										<div class="col-sm-2">
									...
									<div class="form-group">
										<label class="col-sm-2">Initial Amount</label>
										<div class="col-sm-4">
